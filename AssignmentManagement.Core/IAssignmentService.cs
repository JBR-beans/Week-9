...
namespace AssignmentManagement.Core
{
    public interface IAssignmentService
    {
        ...
        bool UpdateAssignment(string title, string newTitle, string newDescription, DateTime newDueDate, AssignmentPriority newPriority, bool newIsCompleted, string newNotes);
